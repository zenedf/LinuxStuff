...
starship_git_info() {
    ...
    # These are supposed to work but do nothing
    # starship module git_state 2>/dev/null
    # starship module git_commit 2>/dev/null
}


# Attempt at customization with starship prompt:
